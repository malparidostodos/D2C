          ...
          <div className="col-span-6 md:col-span-12 w-full">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-[2vw] text-[0.875em] md:text-[1.25em] leading-[1.4] w-full">
              ...
              <div className="col-span-1 flex flex-col gap-4">
                <a href={getLocalizedPath(i18n.language === 'en' ? "/privacy-policy" : "/politica-de-privacidad")} onClick={(e) => { e.preventDefault(); navigateWithTransition(getLocalizedPath(i18n.language === 'en' ? "/privacy-policy" : "/politica-de-privacidad")); }} className="text-[#0046b8] text-[1em] leading-[1.4] font-normal relative w-fit block after:block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-current after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-right hover:after:origin-left">{t('legal.privacy_policy')}</a>
                <a href={getLocalizedPath(i18n.language === 'en' ? "/terms-conditions" : "/terminos-y-condiciones")} onClick={(e) => { e.preventDefault(); navigateWithTransition(getLocalizedPath(i18n.language === 'en' ? "/terms-conditions" : "/terminos-y-condiciones")); }} className="text-[#0046b8] text-[1em] leading-[1.4] font-normal relative w-fit block after:block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-current after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-right hover:after:origin-left">{t('legal.terms_conditions')}</a>
                <a href={getLocalizedPath(i18n.language === 'en' ? "/cookie-policy" : "/politica-de-cookies")} onClick={(e) => { e.preventDefault(); navigateWithTransition(getLocalizedPath(i18n.language === 'en' ? "/cookie-policy" : "/politica-de-cookies")); }} className="text-[#0046b8] text-[1em] leading-[1.4] font-normal relative w-fit block after:block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-current after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-right hover:after:origin-left">{t('legal.cookie_policy')}</a>
                <a href={getLocalizedPath(i18n.language === 'en' ? "/disclaimers" : "/descargos")} onClick={(e) => { e.preventDefault(); navigateWithTransition(getLocalizedPath(i18n.language === 'en' ? "/disclaimers" : "/descargos")); }} className="text-[#0046b8] text-[1em] leading-[1.4] font-normal relative w-fit block after:block after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-current after:w-full after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-right hover:after:origin-left">{t('legal.disclaimers.title')}</a>
              </div>
